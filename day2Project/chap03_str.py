...
# 시퀀스 자료형은 값의 순번(인덱스, index)이 매겨짐, 0부터 시작됨
...
print(tt3.capitalize())  # 문장의 첫 글자를 대문자로 변환 , 나머지는 소문자로

# title() : 각 단어의 첫글자를 대문자로 변화
print(tt3.title())
...
tt5 = 'abc-def-ghi-j'
print('tt5:', tt5)
print(tt5.split('-')) # split() : 지정하는 문자르 ㄹ기준으로 문자값을 분리함
# 여러 개의 문자들로 분리됨 => 리스트 형식이 됨

# splitlnes

# print(tt6)
# print(tt6.splitlenes())
